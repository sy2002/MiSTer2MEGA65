...
create_generated_clock -name qnice_clk       [get_pins framework_inst/i_clk_m2m/i_clk_qnice/CLKOUT0]
create_generated_clock -name hr_clk          [get_pins framework_inst/i_clk_m2m/i_clk_qnice/CLKOUT1]
create_generated_clock -name hr_delay_refclk [get_pins framework_inst/i_clk_m2m/i_clk_qnice/CLKOUT2]
create_generated_clock -name hr_clk_del      [get_pins framework_inst/i_clk_m2m/i_clk_qnice/CLKOUT3]
create_generated_clock -name audio_clk       [get_pins framework_inst/i_clk_m2m/i_clk_audio/CLKOUT0]
create_generated_clock -name tmds_clk        [get_pins framework_inst/i_video_out_clock/MMCM/CLKOUT0]
create_generated_clock -name hdmi_clk        [get_pins framework_inst/i_video_out_clock/MMCM/CLKOUT1]

## The following constraints are needed by M2M/vhdl/controllers/HDMI/video_out_clock.vhd
create_generated_clock -name div_clk -source [get_ports {clk_i}] -divide_by 2 [get_pins framework_inst/i_video_out_clock/clki_div_reg/Q]
set_case_analysis 1 [get_pins framework_inst/i_video_out_clock/clk_mux_reg/Q]

## The high level reset signals are slow enough so that we can afford a false path
set_false_path -from [get_pins framework_inst/i_reset_manager/reset_m2m_n_o_reg/C]
set_false_path -from [get_pins framework_inst/i_reset_manager/reset_core_n_o_reg/C]
...
create_generated_clock -name hr_ck -source [get_pins framework_inst/i_clk_m2m/i_clk_qnice/CLKOUT3] -multiply_by 1 [get_ports hr_clk_p_o]
...
set_property IOB TRUE [get_cells framework_inst/i_hyperram/hyperram_tx_inst/hr_rwds_oe_n_reg ]
set_property IOB TRUE [get_cells framework_inst/i_hyperram/hyperram_tx_inst/hr_dq_oe_n_reg[*] ]
set_property IOB TRUE [get_cells framework_inst/i_hyperram/hyperram_ctrl_inst/hb_csn_o_reg ]
set_property IOB TRUE [get_cells framework_inst/i_hyperram/hyperram_ctrl_inst/hb_rstn_o_reg ]
# setup
...
set_max_delay 2 -datapath_only -from [get_cells framework_inst/i_hyperram/hyperram_ctrl_inst/hb_read_o_reg]
set_max_delay 2 -datapath_only -from [get_cells framework_inst/i_hyperram/hyperram_rx_inst/iddr_dq_gen[*].iddr_dq_inst]
# Prevent insertion of extra BUFG
set_property CLOCK_BUFFER_TYPE NONE [get_nets -of [get_pins framework_inst/i_hyperram/hyperram_rx_inst/delay_rwds_inst/DATAOUT]]
...
create_generated_clock -name sdcard_clk -source [get_pins framework_inst/i_clk_m2m/i_clk_qnice/CLKOUT0] -divide_by 2 \
   [get_pins framework_inst/i_qnice_wrapper/QNICE_SOC/sd_card/Slow_Clock_25MHz_reg/Q]
...
set_multicycle_path -from [get_cells -include_replicated {framework_inst/i_qnice_wrapper/QNICE_SOC/eae_inst/op*_reg[*]}] \
   -to [get_cells -include_replicated {framework_inst/i_qnice_wrapper/QNICE_SOC/eae_inst/res_reg[*]}] -setup 3
set_multicycle_path -from [get_cells -include_replicated {framework_inst/i_qnice_wrapper/QNICE_SOC/eae_inst/op*_reg[*]}] \
   -to [get_cells -include_replicated {framework_inst/i_qnice_wrapper/QNICE_SOC/eae_inst/res_reg[*]}] -hold 2
...
set_false_path -through [get_pins framework_inst/i_av_pipeline/i_digital_pipeline/i_ascal/reset_na]
