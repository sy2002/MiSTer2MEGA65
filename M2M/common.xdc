...
create_generated_clock -name hr_clk          [get_pins framework_inst/clk_m2m_inst/i_clk_qnice/CLKOUT1]
create_generated_clock -name hr_delay_refclk [get_pins framework_inst/clk_m2m_inst/i_clk_qnice/CLKOUT2]
create_generated_clock -name hr_clk_del      [get_pins framework_inst/clk_m2m_inst/i_clk_qnice/CLKOUT3]
...
create_generated_clock -name hr_ck -source [get_pins framework_inst/clk_m2m_inst/i_clk_qnice/CLKOUT3] -multiply_by 1 [get_ports hr_clk_p_o]
...
set_property IOB TRUE [get_cells framework_inst/hyperram_inst/hyperram_tx_inst/hr_rwds_oe_n_reg ]
set_property IOB TRUE [get_cells framework_inst/hyperram_inst/hyperram_tx_inst/hr_dq_oe_n_reg[*] ]
set_property IOB TRUE [get_cells framework_inst/hyperram_inst/hyperram_ctrl_inst/hb_csn_o_reg ]
set_property IOB TRUE [get_cells framework_inst/hyperram_inst/hyperram_ctrl_inst/hb_rstn_o_reg ]
# setup
...
set_max_delay 2 -datapath_only -from [get_cells framework_inst/hyperram_inst/hyperram_ctrl_inst/hb_read_o_reg]
set_max_delay 2 -datapath_only -from [get_cells framework_inst/hyperram_inst/hyperram_rx_inst/iddr_dq_gen[*].iddr_dq_inst]
# Prevent insertion of extra BUFG
set_property CLOCK_BUFFER_TYPE NONE [get_nets -of [get_pins framework_inst/hyperram_inst/hyperram_rx_inst/delay_rwds_inst/DATAOUT]]
