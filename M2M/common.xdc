...
create_generated_clock -name qnice_clk       [get_pins framework_inst/clk_m2m_inst/i_clk_qnice/CLKOUT0]
create_generated_clock -name audio_clk       [get_pins framework_inst/clk_m2m_inst/i_clk_audio/CLKOUT0]
create_generated_clock -name tmds_clk        [get_pins framework_inst/video_out_clock_inst/MMCM/CLKOUT0]
create_generated_clock -name hdmi_clk        [get_pins framework_inst/video_out_clock_inst/MMCM/CLKOUT1]
create_generated_clock -name hr_clk          [get_pins framework_inst/memory_wrapper_inst/clk_memory_inst/clk_mem_inst/CLKOUT0]
create_generated_clock -name hr_delay_refclk [get_pins framework_inst/memory_wrapper_inst/clk_memory_inst/clk_mem_inst/CLKOUT1]
create_generated_clock -name hr_clk_del      [get_pins framework_inst/memory_wrapper_inst/clk_memory_inst/clk_mem_inst/CLKOUT2]

## The following constraints are needed by M2M/vhdl/controllers/HDMI/video_out_clock.vhd
create_generated_clock -name div_clk -source [get_ports {clk_i}] -divide_by 2 [get_pins framework_inst/video_out_clock_inst/clki_div_reg/Q]
set_case_analysis 1 [get_pins framework_inst/video_out_clock_inst/clk_mux_reg/Q]

## The high level reset signals are slow enough so that we can afford a false path
set_false_path -from [get_pins framework_inst/reset_manager_inst/reset_m2m_n_o_reg/C]
set_false_path -from [get_pins framework_inst/reset_manager_inst/reset_core_n_o_reg/C]
...
create_generated_clock -name hr_ck -source [get_pins framework_inst/memory_wrapper_inst/clk_memory_inst/clk_mem_inst/CLKOUT2] -multiply_by 1 [get_ports hr_clk_p_o]
...
set_property IOB TRUE [get_cells framework_inst/memory_wrapper_inst/hyperram_inst/hyperram_tx_inst/hr_rwds_oe_n_reg ]
set_property IOB TRUE [get_cells framework_inst/memory_wrapper_inst/hyperram_inst/hyperram_tx_inst/hr_dq_oe_n_reg[*] ]
set_property IOB TRUE [get_cells framework_inst/memory_wrapper_inst/hyperram_inst/hyperram_ctrl_inst/hb_csn_o_reg ]
set_property IOB TRUE [get_cells framework_inst/memory_wrapper_inst/hyperram_inst/hyperram_ctrl_inst/hb_rstn_o_reg ]
# setup
...
set_max_delay 2 -datapath_only -from [get_cells framework_inst/memory_wrapper_inst/hyperram_inst/hyperram_ctrl_inst/hb_read_o_reg]
set_max_delay 2 -datapath_only -from [get_cells framework_inst/memory_wrapper_inst/hyperram_inst/hyperram_rx_inst/iddr_dq_gen[*].iddr_dq_inst]
# Prevent insertion of extra BUFG
set_property CLOCK_BUFFER_TYPE NONE [get_nets -of [get_pins framework_inst/memory_wrapper_inst/hyperram_inst/hyperram_rx_inst/delay_rwds_inst/DATAOUT]]
...
set_false_path -through [get_pins framework_inst/av_pipeline_inst/i_digital_pipeline/i_ascal/reset_na]
